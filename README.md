...
For detailed documentation about this codebase:

- [AGENTS.md](./AGENTS.md) - Complete documentation index
- [Plugin Development Guide](./docs/guides/adding-new-plugin.md) - How to add new exchange plugins
- [Architecture Overview](./docs/patterns/plugin-architecture.md) - System design and patterns
