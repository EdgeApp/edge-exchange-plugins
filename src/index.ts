...
import { makeSwapsXyzPlugin } from './swap/central/swapsxyz'
...
import { makeSwapsXyzDefiPlugin } from './swap/defi/swapsxyzDefi'
...
const plugins = {
  ...
  swapsxyzdefi: makeSwapsXyzDefiPlugin,
