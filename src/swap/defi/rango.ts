...
const MAINNET_CODE_TRANSCRIPTION: StringMap = {
  arbitrum: 'ARBITRUM',
  // axelar: 'AXELAR', - Not working yet pending response from Rango
  avalanche: 'AVAX_CCHAIN',
  base: 'BASE',
  binancesmartchain: 'BSC',
  // bitcoin: 'BTC',
  celo: 'CELO',
  // cosmoshub: 'COSMOS', - Not working yet pending response from Rango
  // dash: 'DASH',
  // dogecoin: 'DOGE',
  ethereum: 'ETH',
  fantom: 'FANTOM',
  ...
  // okexchain: 'OKC',
  optimism: 'OPTIMISM',
  // osmosis: 'OSMOSIS', - Not working yet pending response from Rango
  polygon: 'POLYGON',
  // thorchainrune: 'THOR', - Not working yet pending response from Rango
  // solana: 'SOLANA',
...
const createAssetString = (
  ...
  if (['COSMOS', 'OSMOSIS', 'THOR'].includes(mainnetCode)) {
