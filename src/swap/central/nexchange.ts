...
export function makeNexchangePlugin(
  ...
  async function getFixedQuote(
    ...
    const expirationDate = ensureInFuture(
      order.fixed_rate_deadline ?? defaultExpiration
    ) as Date
